...
s21::vector<Type_vector>::vector()
    : capacity_(1), size_(0), mass_((Type_vector*)malloc(capacity_ * sizeof(Type_vector))) {}

template <class Type_vector>
s21::vector<Type_vector>::vector(size_type n)
    : capacity_(n + 1), size_(n), mass_((Type_vector*)malloc(capacity_ * sizeof(Type_vector))) {}

template <class Type_vector>
s21::vector<Type_vector>::vector(std::initializer_list<value_type> const& items)
    : capacity_(items.size() + 1),
      size_(items.size()),
